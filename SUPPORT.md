...
Use the repository's public channels for non-sensitive help:
...
maintainer and community; there is no guaranteed response or service level.

Never post Substack cookies, tokens, credentials, private draft content, raw API
responses, or sensitive screenshots. Report security vulnerabilities only
through [GitHub Security Advisories](https://github.com/damienbenveniste/substack-mcp/security/advisories/new),
